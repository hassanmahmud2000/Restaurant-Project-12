        ...
        .then(res=>{
            ...
            if(res.data.modifiedCount >0){
                ...
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: `${res.data.name} Make an Admin!`,
            ...
            <tbody>
              ...
              {users.map((user, index) => (
                <tr key={user._id}>
                  ...
                  <th>
                      {
                        user.role === "Admin" ? <div className="badge badge-secondary">Admin</div> : <button onClick={()=>makeAdminHendler(user._id)} className="btn bg-[#D1A054]"><FaUsers className="text-xl"></FaUsers></button>
                      }
                    </th>
                  <th>
                    {
